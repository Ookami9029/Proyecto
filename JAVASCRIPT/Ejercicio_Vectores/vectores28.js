// Leer 10 números enteros, almacenarlos en un vector y determinar en que posición estÃ¡ el
// numero cuya suma de dígitos sea la mayor.
let contador=1;
...
function sumadigitosmayor(vectorsumadigitos){
    ...
    resultado.textContent=`El numero con la mayor suma de sus dÃ­gitos es ${backup} con el resultado >${mayor}`;
}
...
// 3-Leer 10 números enteros, almacenarlos en un vector y determinar cuantos de los números
...
// 4-Leer 10 números enteros, almacenarlos en un vector y determinar cuantos números de los
...
// 5- Leer 10 números enteros, almacenarlos en un vector y determinar si la semisuma entre el valor mayor y el valor menor es un numero primo.
...
// CASO IMPOSIBLE SOLO PRACTICA condición de seguridad en caso de que sumatotal diera menos de 2, ya que menor a 2 no hay primos
    ...
    if(primo){
        resultado.textContent=`La suma de ${menor} y ${mayor} de los nÃºmeros almacenados es ${sumatotal} y SI ES un numero primo`;
    } else{
        resultado.textContent=`La suma de ${menor} y ${mayor} de los nÃºmeros almacenados es ${sumatotal} y NO es un numero primo`;
    }
}

// 6- Leer 10 numeros enteros, almacenarlos en un vector y determinar si la semisuma entre el valor
// mayor y el valor menor es un numero par.
...
// CASO IMPOSIBLE SOLO PRACTICA condiciÃ³n de seguridad en caso de que sumatotal diera menos de 2, ya que menor a 2 no hay pares
    let sumatotal=menor+mayor;
    if(sumatotal<2){
        inputsumapar.value="";
    ...
    if(par){
        resultado.textContent=`La suma de ${menor} y ${mayor} de los nÃºmeros almacenados es ${sumatotal} y SI ES un numero par`;
    } else{
        resultado.textContent=`La suma de ${menor} y ${mayor} de los nÃºmeros almacenados es ${sumatotal} y NO es un numero par`;
    }
}

// 7- Leer 10 números enteros, almacenarlos en un vector y determinar cuantos números de los
